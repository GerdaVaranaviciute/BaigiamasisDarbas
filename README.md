...
[Baldai1](www.baldai1.lt) webpage should be opened for all test scenarious.
...
#### 1. Search
    ...
    1.1. Search functionality
       ...
       1.2.4. Results title "LOVA" dispayed;
...
#### 2. Shopping cart functionality
    ...
    2.1. Add item to cart 
        ...
        2.1.3. In item page press "Add to cart";
        2.1.4. CLose pop-up;
        2.1.5. Open shopping cart to check if item "Minkðtas kampas Delaware 100" added;

#### 3. Chekout functionality

    3.1. Email error message at the chekout 
        
        3.1.1. Place text cursor in Search textbox;
        3.1.2. Enter item number into searchbox "467169";
        3.1.3. Click enter for the results;
        3.1.4. Open found item;
        3.1.5. Add item using button "Add to cart"
        3.1.6. Press "Go to chekout";
        3.1.7. Enter Vardas "TEST";
        3.1.8. Enter Pavardë "TEST";
        3.1.9. Enter Telefono numeris "862222222";
        3.1.10. Enter El. Paðto adresas "TEST";
        3.1.11. Email error message is visible;

    3.2. Proceed with the payment on delivery method after entering valid customer data
    ...
    3.3. Discount code functionality
        ...
        3.2.3. At the chekout enter text BLACK50 to discount box;
